...
export default function VideoCard({ video }: VideoCardProps) {
  return (
    <Link
      href={`/watch/${video.id}`}
      className="group flex flex-col bg-dark-card border border-dark-border/60 hover:border-brand-red/30 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-brand-red/5"
    >
      {/* Thumbnail */}
